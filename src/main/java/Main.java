...
public class Main {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        ...
        ColumnDataClassifier cdc = new ColumnDataClassifier("./classify.properties");
        cdc.trainClassifier("./classify.txt");
        ...
        // for (String line :
        // ObjectBank.getLineIterator("/home/bill/Desktop/testCoreNlp/classify.test",
        // "utf-8")) {
        ...
        // cdc.testClassifier("/home/bill/Desktop/testCoreNlp/classify.test");
        // System.out.printf("Accuracy: %.3f; macro-F1: %.3f%n", performance.first(),
        // performance.second());
        System.out.println();
        ...
        // document.set(CoreAnnotations.DocDateAnnotation.class,
        ...
        // System.out.print(token.get(NamedEntityTagAnnotation.class) + "/" +
        // token.get(NormalizedNamedEntityTagAnnotation.class) + " ");
        // }
        // System.out.println();
        // }
